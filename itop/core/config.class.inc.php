...
define('ITOP_VERSION', '2.7.5-1'); // @see utils::GetItopVersionShort() and utils::GetItopVersionWikiSyntax()
define('ITOP_REVISION', '7770');
define('ITOP_BUILD_DATE', '2021-07-12 19:29:29');
