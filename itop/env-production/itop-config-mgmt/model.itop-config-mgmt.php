...
/**
 * Classes and menus for itop-config-mgmt (version 2.7.5)
 *
...
class Organization extends cmdbAbstractObject
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeDashboard("overview", array("is_user_editable"=>true, "definition_file"=>'itop-config-mgmt/organization__overview_dashboard.xml', "always_load_in_tables"=>false)));
